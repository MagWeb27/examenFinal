                        ...
                        <td>
                            <div class="flex justify-center gap-2">
                                <a href="{{ route('estudiantes.edit', $estudiante->id) }}"
                                    class="flex justify-center items-center m-2 w-[80px] h-[40px] bg-orange-400 hover:bg-orange-500 rounded text-white">
                                ...
                                <form action="{{ route('estudiantes.destroy', $estudiante->id) }}" method="POST">
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                        class="flex justify-center items-center mt-2 w-[80px] h-[40px] bg-red-400 hover:bg-red-500 rounded text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
